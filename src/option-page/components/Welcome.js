...
export default function Welcome() {
  ...
  const appName = t("appName"); // Image editor Web
  ...
  const subHeadOne = t("subHeadOne"); // Edit Images from your folder or Internet.
  const subHeadOneDesc = t("subHeadOneDesc"); // Do Image Edit on any webpage [using our browser extenion] on the internet or uplaod your image on our website to edit images like a photographer.
  const subHeadTwo = t("subHeadTwo"); // Crop, Add Text, Advanced Effects.
  const subHeadTwoDesc = t("subHeadTwoDesc"); // Crop, Flip, Rotation, Drawing, Shape, Icon, Text, Mask Filter, Image Filter and many advanced filter.
  const labelGettingStarted = t("labelGettingStarted"); // Getting Started
  const labelEditPhotoLike = t("labelEditPhotoLike"); // How to Edit a Photo like a Photographer
  const headF1 = t("headF1"); // Exposure.
  const headF2 = t("headF2"); // Saturation.
  const headF3 = t("headF3"); // Sharpen.
  const headF1Desc = t("headF1Desc"); // Adjust Brightness along with Highlights and Shadows to add contrast.
  const headF2Desc = t("headF2Desc"); // Increase Saturation to enhance colors, decrease it to reduce their intensity.
  const headF3Desc = t("headF3Desc"); // Increase Sharpen to add contrast to the details and lines within your photo.
    ...
    <>
      ...
      <div className="gradient leading-relaxed tracking-wide flex flex-col">
        ...
        <section className="bg-white border-b py-8">
          <div className="container mx-auto flex flex-wrap pt-4 pb-12" spellCheck="true"><h2
              className="w-full my-2 text-5xl font-black leading-tight text-center text-gray-800">{labelEditPhotoLike}</h2>
            <div className="w-full mb-4">
              <div className="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
            </div>
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow"><a
                  className="flex flex-wrap no-underline hover:no-underline"><p
                  className="w-full text-gray-600 text-xs md:text-sm px-6 mt-6">{labelGettingStarted}</p>
                <div className="w-full font-bold text-xl text-gray-800 px-6">{headF1}</div>
                <p className="text-gray-600 text-sm px-6 mb-5" spellCheck="true">{headF1Desc}</p></a></div>
            </div>
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow"><a
                  className="flex flex-wrap no-underline hover:no-underline"><p
                  className="w-full text-gray-600 text-xs md:text-sm px-6 mt-6">{labelGettingStarted}</p>
                <div className="w-full font-bold text-xl text-gray-800 px-6">{headF2}</div>
                <p className="text-gray-600 text-sm px-6 mb-5" spellCheck="true">{headF2Desc}</p><p className="text-gray-600 text-base px-6 mb-5"></p></a>
              </div>
            </div>
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow"><a
                  className="flex flex-wrap no-underline hover:no-underline"><p
                  className="w-full text-gray-600 text-xs md:text-sm px-6 mt-6">{labelGettingStarted}</p>
                <div className="w-full font-bold text-xl text-gray-800 px-6">{headF3}</div>
                <p className="text-gray-600 text-sm px-6 mb-5" spellCheck="true">{headF3Desc}</p><p className="text-gray-600 text-base px-6 mb-5"></p></a>
              </div>
            </div>
          </div>
        </section>
